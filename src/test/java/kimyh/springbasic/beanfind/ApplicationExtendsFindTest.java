...
public class ApplicationExtendsFindTest {
    ...
    void findAllBeanByParentType() {
        java.util.Map<String, DiscountPolicy> beansOfType = ac.getBeansOfType(DiscountPolicy.class);
